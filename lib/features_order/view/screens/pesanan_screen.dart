import '../widgets/bottom_sheet/sort_train.dart';
import '/features_order/view/widgets/bottom_sheet/sort_train.dart';
import '/features_order/view/widgets/train.dart';
...
class _PesananScreenState extends State<PesananScreen> {
  ...
  Widget build(BuildContext context) {
    final initialTabProv = Provider.of<TabProvider>(context, listen: false);
    ...
    return Scaffold(
      ...
      body: ContainedTabBarView(
        ...
        initialIndex: initialTabProv.initialIndex,
      ),
    );
  }
}
