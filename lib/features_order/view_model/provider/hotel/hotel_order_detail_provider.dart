...
class HotelOrderDetailProvider with ChangeNotifier {
  ...
  String? get getQuantityAdult => quantityAdult;
  String? get getNameBank => nameBank;
  ...
  Future<void> setNameBank(String? bank) async {
    nameBank = bank;
    notifyListeners();
  }

  Future<void> setQuantityAdult(String? quantityA) async {
    quantityAdult = quantityA;
    notifyListeners();
  }
