...
//
//     final hotelOrderDetailModel = hotelOrderDetailModelFromJson(jsonString);

import 'dart:convert';

HotelOrderDetailModel hotelOrderDetailModelFromJson(String str) =>
    HotelOrderDetailModel.fromJson(json.decode(str));

String hotelOrderDetailModelToJson(HotelOrderDetailModel data) =>
