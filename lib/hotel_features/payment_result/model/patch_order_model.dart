...
//
//     final patchOrderHotelResponseModel = patchOrderHotelResponseModelFromJson(jsonString);

import 'dart:convert';

PatchOrderHotelResponseModel patchOrderHotelResponseModelFromJson(String str) =>
    PatchOrderHotelResponseModel.fromJson(json.decode(str));

String patchOrderHotelResponseModelToJson(PatchOrderHotelResponseModel data) =>
    json.encode(data.toJson());

class PatchOrderHotelResponseModel {
  int? statusCode;
  String? message;
  Data? data;

  PatchOrderHotelResponseModel({
    this.statusCode,
    this.message,
    this.data,
  });

  factory PatchOrderHotelResponseModel.fromJson(Map<String, dynamic> json) =>
      PatchOrderHotelResponseModel(
