...
//
//     final postOrderDataResponseModel = postOrderDataResponseModelFromJson(jsonString);

import 'dart:convert';

PostOrderDataResponseModel postOrderDataResponseModelFromJson(String str) =>
    PostOrderDataResponseModel.fromJson(json.decode(str));

String postOrderDataResponseModelToJson(PostOrderDataResponseModel data) =>
    json.encode(data.toJson());

class PostOrderDataResponseModel {
  int? statusCode;
  String? message;
  Data? data;

  PostOrderDataResponseModel({
    this.statusCode,
    this.message,
    this.data,
  });

  factory PostOrderDataResponseModel.fromJson(Map<String, dynamic> json) =>
      PostOrderDataResponseModel(
