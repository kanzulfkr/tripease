...
class CarriageDepartureProvider with ChangeNotifier {
  ...
  void updateSeatLists() {
    if (_carriage.isNotEmpty) {
      if (_carriage[_selectedTabIndex as int].seat != null) {
        ...
        debugPrint('Added carriage-departure');
        notifyListeners();
      } else {
        _seatA.clear();
        _seatB.clear();
        ...
        _seatD.clear();
        _seatE.clear();
        debugPrint('Cleared carriage-departure1');
        notifyListeners();
      }
    } else {
      _seatA.clear();
      ...
      _seatD.clear();
      _seatE.clear();
      debugPrint('Cleared carriage-departure2');
      notifyListeners();
    }
  }

  Future<void> fetchCarriageDeparture({
