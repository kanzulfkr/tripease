...
class _HelpScreenState extends State<HelpScreen> {
  ...
  @override
  initState() {
    final artc = Provider.of<ArticleProvider>(context, listen: false);
    artc.getSearchArticle();
    ...
    return Consumer<ArticleProvider>(
      builder: (context, value, child) => Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    onTap: () {
                      setState(() {
                        value.getSearchArticle();
                        allTopics = value.allArticle;
                        // print("ontapppp : ${value.allArticle}");
                        isTap = true;
                      });
                    },
                    onChanged: (value) {
        ...
        body: isTap
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              onTap: () {
                                final id =
                                    value.listAllArticle[index].articleId;
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      padding: EdgeInsets.symmetric(
                                          horizontal: 20.w),
                                      child: Text(
                                        foundTopics[index]["slug"].toString(),
                                        style: GoogleFonts.openSans(
                                          fontSize: 12.sp,
            ...
            : InkWell(
                onTap: () {
                  print(value.listAllArticle[0].description);
                },
                child: const PopularTopic()),
      ),
    );
  }
}
