...
import '../../../../../features_rincian_pesanan_hotel/view/pesanan_kembali_gagal.dart';
import '../../../../utils/colors.dart';
import '../../../../utils/fonts.dart';

class CardReturnCanceledHotel extends StatelessWidget {
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => const PesananKembaliGagal(),
          ),
        );
      },
      child: Column(
