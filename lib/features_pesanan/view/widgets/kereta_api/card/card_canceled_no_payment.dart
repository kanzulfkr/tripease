...
import 'package:capstone_project_tripease/features_rincian_pesanan_ka/view/order_kai_failed_no_payment.dart';
...
class CardCanceledNoPaymentKA extends StatelessWidget {
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => const OrderKaiFailedPaymentPage(),
          ),
        );
      },
      child: Column(
