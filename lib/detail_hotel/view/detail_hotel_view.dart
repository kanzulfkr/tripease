      ...
      body: ChangeNotifierProvider<DetailHotelViewModel>(
        create: (_) => DetailHotelViewModel(
          htl: DetailHotel(
            ...
            rooms: [
              Room(name: 'Deluxe', price: 'Rp 1.835.000', imageUrls: ['assets/images/detail_k1.jpeg', 'assets/images/detail_k2.jpeg', 'assets/images/detail_k3.jpeg'], capacity: '2 Tamu', bedType: '1 Twin', breakfast: 'Sarapan (2 paket)', refund: 'Pengembalian Dana', wifi: 'Wifi Gratis', reSchedule: 'Perubahan Jadwal', noSmoking: 'Dilarang Merokok', navigateUrl: 'Deluxe', deskripsi:'Kamar Deluxe Room kami menawarkan kenyamanan dan gaya dengan desain modern yang elegan. Dilengkapi dengan tempat tidur Twin, ruangan ini memiliki fasilitas lengkap untuk memastikan pengalaman menginap yang memuaskan', fasilitas: ['AC', 'Minibar', 'Brankas', 'Teko Elektrik', 'Kulkas', 'Sandal', 'Lemari', 'Telepon Hotel', 'Meja Tulis', 'TV Layar Datar', 'Peralatan Mandi', 'Layanan Bintau', 'Pelayanan 24 Jam', 'Shower', 'Handuk'], asuransi: '183.500', subtotal: 'Rp 1.835.000', total: 'Rp 1.968.500'),
              Room(name: 'Executive', price: 'Rp 2.375.000', imageUrls: ['assets/images/detail_k2.jpeg', 'assets/images/detail_k1.jpeg'], capacity: '2 Tamu', bedType: '1 King', breakfast: 'Sarapan (2 paket)', refund: 'Pengembalian Dana', wifi: 'Wifi Gratis', reSchedule: 'Perubahan Jadwal', noSmoking: 'Dilarang Merokok', navigateUrl: 'Executive', deskripsi: 'Kamar Executive Room kami menawarkan kenyamanan dan gaya dengan desain modern yang elegan. Dilengkapi dengan tempat tidur Twin, ruangan ini memiliki fasilitas lengkap untuk memastikan pengalaman menginap yang memuaskan', fasilitas: ['AC', 'Minibar', 'Brankas', 'Teko Elektrik', 'Kulkas', 'Sandal', 'Lemari', 'Telepon Hotel', 'Meja Tulis', 'TV Layar Datar', 'Peralatan Mandi', 'Layanan Bintau', 'Pelayanan 24 Jam', 'Shower', 'Handuk'], asuransi: '237.500', subtotal: 'Rp 2.375.000', total: 'Rp 2.562.500'),
              Room(name: 'Suite', price: 'Rp 2.850.000', imageUrls: ['assets/images/detail_k1.jpeg', 'assets/images/detail_k1.jpeg'], capacity: '4 Tamu', bedType: '2 Queen', breakfast: 'Sarapan (4 paket)', refund: 'Pengembalian Dana', wifi: 'Wifi Gratis', reSchedule: 'Perubahan Jadwal', noSmoking: 'Dilarang Merokok', navigateUrl: 'Suite', deskripsi: 'Kamar Suite Room kami menawarkan kenyamanan dan gaya dengan desain modern yang elegan. Dilengkapi dengan tempat tidur Twin, ruangan ini memiliki fasilitas lengkap untuk memastikan pengalaman menginap yang memuaskan', fasilitas: ['AC', 'Minibar', 'Brankas', 'Teko Elektrik', 'Kulkas', 'Sandal', 'Lemari', 'Telepon Hotel', 'Meja Tulis', 'TV Layar Datar', 'Peralatan Mandi', 'Layanan Bintau', 'Pelayanan 24 Jam', 'Shower', 'Handuk'], asuransi: '285.000', subtotal: 'Rp 2.850.000', total: 'Rp 3.085.000'),
              Room(name: 'Family', price: 'Rp 3.500.000', imageUrls: ['assets/images/detail_k2.jpeg', 'assets/images/detail_k2.jpeg'], capacity: '6 Tamu', bedType: '2 King + 1 Singke', breakfast: 'Sarapan (6 paket)', refund: 'Pengembalian Dana', wifi: 'Wifi Gratis', reSchedule: 'Perubahan Jadwal', noSmoking: 'Dilarang Merokok', navigateUrl: 'Family', deskripsi: 'Kamar Family Room kami menawarkan kenyamanan dan gaya dengan desain modern yang elegan. Dilengkapi dengan tempat tidur Twin, ruangan ini memiliki fasilitas lengkap untuk memastikan pengalaman menginap yang memuaskan', fasilitas: ['AC', 'Minibar', 'Brankas', 'Teko Elektrik', 'Kulkas', 'Sandal', 'Lemari', 'Telepon Hotel', 'Meja Tulis', 'TV Layar Datar', 'Peralatan Mandi', 'Layanan Bintau', 'Pelayanan 24 Jam', 'Shower', 'Handuk'], asuransi: '350.000', subtotal: 'Rp 3.500.000', total: 'Rp 3.800.000'),
            ],
          ),
        ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: PageView.builder(
                      ...
                      itemCount: hotelAssetsList.length,
