...
class OrderKaiRefundFailedPage extends StatelessWidget {
  const OrderKaiRefundFailedPage({super.key});
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Image.network(orderDetail.getImagePayment ?? '',
                            ...
                            children: [
                              ...
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('${orderDetail.getClassTrain ?? ''} Dewasa x${orderDetail.getQuantityAdult ?? ''}, Anak x${orderDetail.getQuantityInfant ?? ''}',
                                      style: GoogleFonts.openSans(
                                        fontSize: 12.sp,
                                        fontWeight: FontWeight.w400,
                                      )),
