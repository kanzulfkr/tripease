...
class _AnotherPageState extends State<AnotherPage> {
  ...
  List<PaymentMethod> paymentMethods = [
    PaymentMethod('Kartu Kredit', 'assets/CC.jpeg', ['A', 'B'], ),
    PaymentMethod('Virtual Account', 'assets/VA.jpeg', ['C', 'D'],),
    PaymentMethod('OVO', 'assets/OVO.jpeg', ['E', 'F']),
    PaymentMethod('Gopay', 'assets/Gopay.jpeg', ['G', 'H']),
    PaymentMethod('Minimarket', 'assets/Minimarket.jpeg', ['I', 'J']),
    PaymentMethod('Bayar di Hotel', 'assets/Hotel.jpeg', ['K', 'L']),
  ];
                      ...
                      children: [
                        ...
                        Container(
                          child: Row(                           
                            children: [
                              Checkbox(
                                value: true, // Set the initial value of the checkbox here
                                ...
                                child: Row(
                                  children: [
                                    Container(
                                      width: 20,
                                      height: 20,
                                      child: Image.asset('assets/vector.jpeg'),
                                    ),
                                    SizedBox(width: 10,),
                                    Container(
                                      height: 44,
