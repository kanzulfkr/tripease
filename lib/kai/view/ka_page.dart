...
import 'package:capstone_project_tripease/kai/view/departure.dart';
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            onTap: () {
                              _showCariBottomSheet(context, stationProvider);
                            },
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            readOnly: true,
                            onTap: () {
                              _showCariBottomSheet2(context, stationProvider);
                            },
                            autovalidateMode:
                              ...
                              builder: (context, stationProvider, child) {
                                return Container(
                                  ...
                                  child: CupertinoSwitch(
                                    ...
                                    onChanged: (newValue) {
                                      stationProvider.setPulangPergi(newValue);
                                    },
                                  ),
                                );
                              },
                                ...
                                return DropdownButtonHideUnderline(
                                  child: DropdownButton2<String>(
                                    ...
                                    onChanged: (String? value) {
                                      departureProvider.setSelectedClass(value);
                                      jenisKAController.text = departureProvider
                                          .selectedClass
                                          .toString();
                                    },
                                    items: dropdownItems
                        ...
                        return Center(
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              if (_formKey.currentState!.validate()) {
                                var originId = stationProvider.idOrigin as int;
                                var destinationId =
